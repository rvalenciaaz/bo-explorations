...
ax[0].set_title('Branin Function Contour Plot', fontsize=16)
...
ax[1].invert_yaxis()
ax[1].set_title('Heatmap of Mean Iterations to Reach Maximum', fontsize=16)
ax[1].set_xlabel('Initial Samples', fontsize=14)
ax[1].set_ylabel('Batch Size', fontsize=14)

# Add labels "A" and "B" outside the plots, near the upper left corners
ax[0].text(-0.1, 1.05, 'A', transform=ax[0].transAxes, fontsize=20, fontweight='bold', va='top', ha='right')
ax[1].text(-0.1, 1.05, 'B', transform=ax[1].transAxes, fontsize=20, fontweight='bold', va='top', ha='right')

# Adjust layout and display the plot
plt.tight_layout()
plt.savefig("combined_branin_heatmap_with_labels.png", dpi=600, transparent=True, bbox_inches="tight")
plt.show()
